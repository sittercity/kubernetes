...
func (s *APIServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.EtcdConfig.Username, "etcd-username", s.EtcdConfig.Username, "Username to use for etcd BasicAuth.")
	fs.StringVar(&s.EtcdConfig.Password, "etcd-password", s.EtcdConfig.Password, "Password to use for etcd BasicAuth.")
